...
namespace TrenchBroom {
    namespace View {
        ...
        m_labelStaticText(new wxStaticText(m_panel, wxID_ANY, "")),
        m_resetOnNextKey(false) {
            ...
            m_labelStaticText->Bind(wxEVT_LEFT_DOWN, &KeyboardShortcutEditor::OnMouseDown, this);
            m_labelStaticText->Bind(wxEVT_RIGHT_DOWN, &KeyboardShortcutEditor::OnMouseDown, this);
            m_labelStaticText->Bind(wxEVT_LEFT_DCLICK, &KeyboardShortcutEditor::OnMouseDown, this);
        }
        ...
        void KeyboardShortcutEditor::OnSetFocus(wxFocusEvent& event) {
            ...
            m_labelStaticText->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHTTEXT));
            Refresh();
            event.Skip();
        }
        ...
        void KeyboardShortcutEditor::OnKillFocus(wxFocusEvent& event) {
            ...
            m_labelStaticText->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_LISTBOXTEXT));
            Refresh();
            event.Skip();
        }
